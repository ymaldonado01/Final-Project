    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x77u] = {
/* Device Name */
(uint8)'M', (uint8)'y', (uint8)'T', (uint8)'h', (uint8)'e', (uint8)'r', (uint8)'m', (uint8)'o', (uint8)'m', (uint8)'e',
(uint8)'t', (uint8)'e', (uint8)'r', 
...
/* Model Number String */
(uint8)'1', (uint8)'.', (uint8)'0', 

/* Serial Number String */
(uint8)'*', (uint8)'*', 

/* Hardware Revision String */
(uint8)'C', (uint8)'Y', (uint8)'8', (uint8)'C', (uint8)'K', (uint8)'I', (uint8)'T', (uint8)'-', (uint8)'0', (uint8)'4',
(uint8)'2', (uint8)'-', (uint8)'B', (uint8)'L', (uint8)'E', 

/* Firmware Revision String */
(uint8)'*', (uint8)'*', 

/* Software Revision String */
(uint8)'P', (uint8)'S', (uint8)'o', (uint8)'C', (uint8)' ', (uint8)'C', (uint8)'r', (uint8)'e', (uint8)'a', (uint8)'t',
(uint8)'o', (uint8)'r', (uint8)' ', (uint8)'3', (uint8)'.', (uint8)'1', 
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x2Bu] = {
...
{ 0x0003u, 0x2A00u /* Device Name                         */, 0x00000201u /* rd     */, 0x0003u, {{0x000Du, (void *)&cyBle_attValues[0]}}    },
{ 0x0004u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0005u, {{0x2A01u, NULL}}                           },
{ 0x0005u, 0x2A01u /* Appearance                          */, 0x00000201u /* rd     */, 0x0005u, {{0x0002u, (void *)&cyBle_attValues[13]}}   },
{ 0x0006u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0007u, {{0x2A04u, NULL}}                           },
{ 0x0007u, 0x2A04u /* Peripheral Preferred Connection Par */, 0x00000201u /* rd     */, 0x0007u, {{0x0008u, (void *)&cyBle_attValues[15]}}   },
...
{ 0x000Au, 0x2A05u /* Service Changed                     */, 0x00002201u /* rd,ind */, 0x000Bu, {{0x0004u, (void *)&cyBle_attValues[23]}}   },
...
{ 0x000Du, 0x2803u /* Characteristic                      */, 0x00002001u /* ind    */, 0x000Fu, {{0x2A1Cu, NULL}}                           },
{ 0x000Eu, 0x2A1Cu /* Temperature Measurement             */, 0x00002000u /* ind    */, 0x000Fu, {{0x0005u, (void *)&cyBle_attValues[27]}}   },
{ 0x000Fu, 0x2902u /* Client Characteristic Configuration */, 0x00000A04u /* rd,wr  */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesCCCD[2]}} },
{ 0x0010u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0011u, {{0x2A1Du, NULL}}                           },
{ 0x0011u, 0x2A1Du /* Temperature Type                    */, 0x00000201u /* rd     */, 0x0011u, {{0x0001u, (void *)&cyBle_attValues[32]}}   },
{ 0x0012u, 0x2803u /* Characteristic                      */, 0x00001001u /* ntf    */, 0x0014u, {{0x2A1Eu, NULL}}                           },
{ 0x0013u, 0x2A1Eu /* Intermediate Temperature            */, 0x00001000u /* ntf    */, 0x0014u, {{0x0005u, (void *)&cyBle_attValues[33]}}   },
{ 0x0014u, 0x2902u /* Client Characteristic Configuration */, 0x00000A04u /* rd,wr  */, 0x0014u, {{0x0002u, (void *)&cyBle_attValuesCCCD[4]}} },
{ 0x0015u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0018u, {{0x2A21u, NULL}}                           },
{ 0x0016u, 0x2A21u /* Measurement Interval                */, 0x00000A04u /* rd,wr  */, 0x0018u, {{0x0002u, (void *)&cyBle_attValues[38]}}   },
{ 0x0017u, 0x2902u /* Client Characteristic Configuration */, 0x00000A04u /* rd,wr  */, 0x0017u, {{0x0002u, (void *)&cyBle_attValuesCCCD[6]}} },
{ 0x0018u, 0x2906u /* Valid Range                         */, 0x00000201u /* rd     */, 0x0018u, {{0x0004u, (void *)&cyBle_attValues[40]}}   },
{ 0x0019u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x002Bu, {{0x180Au, NULL}}                           },
{ 0x001Au, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x001Bu, {{0x2A29u, NULL}}                           },
{ 0x001Bu, 0x2A29u /* Manufacturer Name String            */, 0x00000201u /* rd     */, 0x001Bu, {{0x0015u, (void *)&cyBle_attValues[44]}}   },
{ 0x001Cu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x001Du, {{0x2A24u, NULL}}                           },
{ 0x001Du, 0x2A24u /* Model Number String                 */, 0x00000201u /* rd     */, 0x001Du, {{0x0003u, (void *)&cyBle_attValues[65]}}   },
{ 0x001Eu, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x001Fu, {{0x2A25u, NULL}}                           },
{ 0x001Fu, 0x2A25u /* Serial Number String                */, 0x00000201u /* rd     */, 0x001Fu, {{0x0002u, (void *)&cyBle_attValues[68]}}   },
{ 0x0020u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0021u, {{0x2A27u, NULL}}                           },
{ 0x0021u, 0x2A27u /* Hardware Revision String            */, 0x00000201u /* rd     */, 0x0021u, {{0x000Fu, (void *)&cyBle_attValues[70]}}   },
{ 0x0022u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0023u, {{0x2A26u, NULL}}                           },
{ 0x0023u, 0x2A26u /* Firmware Revision String            */, 0x00000201u /* rd     */, 0x0023u, {{0x0002u, (void *)&cyBle_attValues[85]}}   },
{ 0x0024u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0025u, {{0x2A28u, NULL}}                           },
{ 0x0025u, 0x2A28u /* Software Revision String            */, 0x00000201u /* rd     */, 0x0025u, {{0x0010u, (void *)&cyBle_attValues[87]}}   },
{ 0x0026u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0027u, {{0x2A23u, NULL}}                           },
{ 0x0027u, 0x2A23u /* System ID                           */, 0x00000201u /* rd     */, 0x0027u, {{0x0008u, (void *)&cyBle_attValues[103]}}  },
{ 0x0028u, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x0029u, {{0x2A2Au, NULL}}                           },
{ 0x0029u, 0x2A2Au /* IEEE 11073-20601 Regulatory Certifi */, 0x00000201u /* rd     */, 0x0029u, {{0x0001u, (void *)&cyBle_attValues[111]}}  },
{ 0x002Au, 0x2803u /* Characteristic                      */, 0x00000201u /* rd     */, 0x002Bu, {{0x2A50u, NULL}}                           },
{ 0x002Bu, 0x2A50u /* PnP ID                              */, 0x00000201u /* rd     */, 0x002Bu, {{0x0007u, (void *)&cyBle_attValues[112]}}  },
};
