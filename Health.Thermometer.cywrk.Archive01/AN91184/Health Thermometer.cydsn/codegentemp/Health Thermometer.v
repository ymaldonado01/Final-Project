// ======================================================================
// Health Thermometer.v generated from TopDesign.cysch
// 12/06/2016 at 09:52
...
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\AMuxSeq_v1_80"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\3.1\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\AMuxSeq_v1_80\AMuxSeq_v1_80.v"
`endif
...
module top ;
    ...
    cy_psoc3_amux_v1_0 AMuxSeq_CYAMUXSIDE_A(
        .muxin({
            Net_292,
            Net_290,
            Net_535
    ...
    defparam AMuxSeq_CYAMUXSIDE_A.muxin_width = 3;
    defparam AMuxSeq_CYAMUXSIDE_A.init_mux_sel = 3'h0;
    defparam AMuxSeq_CYAMUXSIDE_A.api_type = 1'b1;
    defparam AMuxSeq_CYAMUXSIDE_A.one_active = 1;
    defparam AMuxSeq_CYAMUXSIDE_A.connect_mode = 1;
    
    
    // -- Mux B --
    
    cy_psoc3_amux_v1_0 AMuxSeq_CYAMUXSIDE_B(
        .muxin({
            Net_292,
            Net_292,
            Net_290
    ...
    defparam AMuxSeq_CYAMUXSIDE_B.muxin_width = 3;
    defparam AMuxSeq_CYAMUXSIDE_B.init_mux_sel = 3'h0;
    defparam AMuxSeq_CYAMUXSIDE_B.api_type = 1'b1;
    defparam AMuxSeq_CYAMUXSIDE_B.one_active = 1;
    defparam AMuxSeq_CYAMUXSIDE_B.connect_mode = 1;
	...
	wire [0:0] tmpOE__V_HIGH_net;
	wire [0:0] tmpFB_0__V_HIGH_net;
	wire [0:0] tmpIO_0__V_HIGH_net;
	wire [0:0] tmpINTERRUPT_0__V_HIGH_net;
	electrical [0:0] tmpSIOVREF__V_HIGH_net;
	...
	cy_psoc3_pins_v1_10
		...
		V_HIGH
		 (.oe(tmpOE__V_HIGH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_HIGH_net[0:0]}),
		  .analog({Net_535}),
		  .io({tmpIO_0__V_HIGH_net[0:0]}),
		  .siovref(tmpSIOVREF__V_HIGH_net),
		  .interrupt({tmpINTERRUPT_0__V_HIGH_net[0:0]}),
		  .annotation({Net_98}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__V_HIGH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__V_THERM_net;
	wire [0:0] tmpFB_0__V_THERM_net;
	wire [0:0] tmpIO_0__V_THERM_net;
	wire [0:0] tmpINTERRUPT_0__V_THERM_net;
	electrical [0:0] tmpSIOVREF__V_THERM_net;

	cy_psoc3_pins_v1_10
		#(.id("7e4f3ba3-a747-49c6-904c-c27a8697a420"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		V_THERM
		 (.oe(tmpOE__V_THERM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_THERM_net[0:0]}),
		  .analog({Net_290}),
		  .io({tmpIO_0__V_THERM_net[0:0]}),
		  .siovref(tmpSIOVREF__V_THERM_net),
		  .interrupt({tmpINTERRUPT_0__V_THERM_net[0:0]}),
		  .annotation({Net_103}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__V_THERM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__V_LOW_net;
	wire [0:0] tmpFB_0__V_LOW_net;
	wire [0:0] tmpIO_0__V_LOW_net;
	wire [0:0] tmpINTERRUPT_0__V_LOW_net;
	electrical [0:0] tmpSIOVREF__V_LOW_net;

	cy_psoc3_pins_v1_10
		#(.id("48c1894f-9914-45d2-a462-408d2c7468cb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		V_LOW
		 (.oe(tmpOE__V_LOW_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_LOW_net[0:0]}),
		  .analog({Net_292}),
		  .io({tmpIO_0__V_LOW_net[0:0]}),
		  .siovref(tmpSIOVREF__V_LOW_net),
		  .interrupt({tmpINTERRUPT_0__V_LOW_net[0:0]}),
		  .annotation({Net_104}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__V_LOW_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 R_Therm (
        .connect({
            Net_103,
            Net_104
        })
    );
    defparam R_Therm.comp_name = "Thermistor_v1_0";
    defparam R_Therm.port_names = "T1, T2";
    defparam R_Therm.width = 2;

    cy_annotation_universal_v1_0 R_Ref (
        .connect({
            Net_98,
            Net_103
        })
    );
    defparam R_Ref.comp_name = "Resistor_v1_0";
    defparam R_Ref.port_names = "T1, T2";
    defparam R_Ref.width = 2;
